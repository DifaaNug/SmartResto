    ...
    <>
      <div className="flex items-center justify-center min-h-screen">
        <div>
          ...
          <div className="flex items-center justify-center w-96 hover:shadow-xl h-8 mt-6 border rounded-lg font-bold" style={{ backgroundColor: '#5a4fcf' }}>
            <button className="text-white text-sm">Login</button>
          </div>
        </div>
      </div>
      <a href="../dashboardPelayan/index.tsx">aa</a>
    </>
  )
}
